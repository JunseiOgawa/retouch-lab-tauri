...
- **タブ切り替え**: `Classic / Math` と `AI / Hybrid`
- **プルダウン切り替え**: 各タブ内の手法を選択
- **複数レタッチ手法（8種）**
  - Classic: Auto Balance / Vibrance / Highlight Recovery / Gamma / Local Clarity
  - AI: K-Means Scene Model
  - Hybrid: Skin-Aware Tone / Subject Pop
- **Before/After プレビュー**
